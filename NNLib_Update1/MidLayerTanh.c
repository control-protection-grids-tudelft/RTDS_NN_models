...
for (k = 0; k<Y; k++){
indx = 6*k;
a2[k] = tanh(W[0+indx]*X[0] + W[1+indx]*X[1] + W[2+indx]*X[2] +W[3+indx]*X[3] +W[4+indx]*X[4] + W[5+indx]*X[5] + b[k]);
da[k] = 1- a2[k]*a2[k];
}
}
...
static void Backprop(double Loss[6], double da2[6], int N, int Y, double alpha){
da1[0] = 0.0;
da1[1] = 0.0;
da1[2] = 0.0;
da1[3] = 0.0;
...
Backprop(loss, da2, N, Y, Learning_rate);
